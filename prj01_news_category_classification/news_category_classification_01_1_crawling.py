...
# from date import time 해주면  datetime.today().strftime('%Y%m%d')
...
df_titles.to_csv('./crawling/naver_headline_news{}.csv'.format(datetime.datetime.today().strftime('%Y%m%d')))